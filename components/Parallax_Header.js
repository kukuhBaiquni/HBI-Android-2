...
class RNParallax extends Component {
  ...
  renderHeaderTitle() {
    const { title, titleStyle, renderBackButton, renderCartIcon } = this.props;
    ...
    return (
      ...
      <Animated.View style={{position: 'absolute', left: 0, marginLeft: 10, opacity: this.transparency2()}}>
        ...
        <Animated.Text numberOfLines={1} style={[styles.headerText, titleStyle, {color: this.titleTransition(), width: this.titleWidth()}]}>
          {title}
        </Animated.Text>
